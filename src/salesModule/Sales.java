...
public class Sales{
	...
	public void step(WebDriver driver) throws InterruptedException{
		//Setting Checked in Hide or Show
		...
		if(!driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry_new][item_no]']")).isSelected()){
			driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry_new][item_no]']")).click();
		}
		if(!driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry_new][descrp]']")).isSelected()){
			driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry_new][descrp]']")).click();
		}
		Thread.sleep(5000);
		driver.findElement(By.id("getOgpLsit")).click();
		...
		Thread.sleep(5000);
		builder.moveToElement( from.findElement(By.xpath("/html/body/div/div[4]/div[2]/div/div[3]/div/div[1]/div/form/div[2]/div/div/div[2]/div[2]/table/thead/tr/th/div/div/div[2]/a/div/div[2]"))).click().build().perform();
		//----------
		...
		Thread.sleep(5000);
		builder2.moveToElement(product.findElement(By.xpath("/html/body/div/div[4]/div[2]/div/div[3]/div/div[1]/div/form/div[2]/div/div/div[4]/div/div/div[2]/div/div[1]/div[1]/div/a/div/div[2]"))).click().build().perform();  
		Thread.sleep(3000);
		//Write Description
		...
		Thread.sleep(3000);
		builder3.moveToElement(product.findElement(By.xpath("/html/body/div/div[4]/div[2]/div/div[3]/div/div[1]/div/form/div[2]/div/div/div[4]/div/div/div[2]/div[2]/div[1]/div[1]/div/a/div/div[2]"))).click().build().perform();  
		Thread.sleep(3000);
		...
		//Varify Hide & Show Data
		Thread.sleep(5000);
		driver.findElement(By.className("btn-sm")).click();
		Thread.sleep(2000);
		if(!driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry][pr_name]']")).isSelected()){
			driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry][pr_name]']")).click();
		}
		if(!driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry][descrp]']")).isSelected()){
			driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry][descrp]']")).click();
		}
		if(driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry][item_group]']")).isSelected()){
			driver.findElement(By.xpath("//input[@type='checkbox' and @name='report[sale_inquiry][item_group]']")).click();
		}
		Thread.sleep(5000);
		driver.findElement(By.id("getOgpLsit")).click();
